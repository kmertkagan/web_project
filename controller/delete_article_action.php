...
if ($blog_datas = $blog->Select_Specified_Blogs(["id"=>$get_id])){
    ...
    if (( ($_SESSION['id'] ?? null) == $blogger_data[0]['id'] || ($_SESSION["role_id"] ?? null ) == 2)) { // yazar gerçekten blogu yazan kişi mi ya da admin mi? eğer id'si yoksa null döner bu da zaten sağlanmaz
