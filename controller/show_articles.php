        ...
        if (!isset($_POST["category"]) || $_POST["category"] == "All" ) {
            ...
            if ($rows = $blogs->Select_Blogs("","","","","","")){
                ...
                foreach($rows as $data){
                    ...
                    echo "Yazar: "."<strong class='blogger'>".htmlspecialchars($row[0]["username"])."</strong>";
                    echo "<a class='blog' href='get_article?id=".strval($data["id"])."'>"."<h3>".htmlspecialchars($data["title"]). "</h3></a>";
                    echo "<br>";
                    echo "Kategori: ".htmlspecialchars($data["category"])."<p>".$data["posted_on"]."</p>";
        ...
        } else 
        {
            ...
            if ($blogrows!=null) {
                ...
                foreach ($blogrows as $row) {
                    ...
                    echo "Yazar: "."<strong class='blogger'>".htmlspecialchars($blogerows[0]["username"])."</strong>";
                    echo "<a class='blog' href='get_article?id=".strval($row["id"])."'>"."<h3>".htmlspecialchars($row["title"]). "</h3></a>";
                    echo "<br>";
                    echo "Kategori: ".htmlspecialchars($row["category"])."<p>".$row["posted_on"]."</p>";
